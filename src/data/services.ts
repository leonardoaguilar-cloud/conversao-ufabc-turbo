...
export const services: ServiceData[] = [
  ...
  // ============ ANÁLISE DE DADOS ============
  {
    ...
    cases: [
      {
        client: "Kap",
        segment: "Empresa de Serviços de Eventos",
        result: "Os dashboards desenvolvidos otimizaram a análise de dados, apoiando decisões mais assertivas e um planejamento financeiro mais eficiente. NPS e CSAT nota 10.",
        metric: "8 Dashboards Entregues",
        quote: "A Kap buscava transformar suas bases de dados em informações estratégicas para melhorar a gestão de clientes e o planejamento financeiro. A UFABC Jr. desenvolveu dashboards de Business Intelligence que centralizaram indicadores essenciais, proporcionando maior controle sobre inadimplência, conversão de leads e tomada de decisões.",
      },
      {
        client: "Renova Energia",
        segment: "Empresa do ramo de Geração de Energia Elétrica",
        result: "Satisfação máxima da Renova Energia com o serviço: NPS e CSAT nota 10.",
        metric: "100% de aprovação",
        quote: "A Renova Energia buscava identificar oportunidades no Mercado Livre de Energia por meio de uma visão estruturada do setor de saneamento básico. A UFABC Jr. desenvolveu uma análise de dados com dashboards interativos que transformaram informações de mercado em insights estratégicos para apoiar a prospecção e a expansão comercial.",
      },
    ],
    cta: {
