...
const TITLE = "Análise de Dados e Dashboards para Empresas | UFABC Jr.";
const DESCRIPTION =
  "Transformamos suas bases em dashboards interativos e análises acionáveis para decisões em tempo real. Diagnóstico gratuito com a Empresa Júnior da UFABC.";
const CANONICAL = "https://ufabcjr.com.br/analise-de-dados";

const differentials = [
  "Bases organizadas e tratadas, sem planilhas soltas",
  "Dashboards interativos com os indicadores que importam",
  "Análises estatísticas que explicam o porquê dos números",
  "Rotina de acompanhamento para decisões em tempo real",
];

const AnaliseDados = () => {
  const ctaRef = useRef<HTMLDivElement>(null);
  const service = services.find((s) => s.id === "dados")!;
        ...
        <section className="py-16 md:py-20 border-t border-border bg-background">
          <div className="container max-w-4xl text-center">
            ...
            <h2 className="font-display text-3xl md:text-4xl font-medium leading-tight text-balance mb-10">
              Dados que viram decisão — não relatórios parados.
            </h2>
