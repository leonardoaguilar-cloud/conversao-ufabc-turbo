      ...
      <main>
        ...
        <section className="border-y py-8 overflow-hidden border-neutral-100 bg-background">
          <div className="container max-w-7xl relative bg-background border-background">
            <div className="text-center uppercase tracking-[0.25em] text-muted-foreground mb-6 text-xl font-bold text-emerald-950">
            ...
            <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(320px,0.9fr)] lg:items-center">
              <div className="max-w-3xl text-left">
                ...
                <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-medium text-balance leading-[1.05]">
                  Empresa Júnior da UFABC. <em className="italic text-paper/60 text-2xl md:text-3xl lg:text-4xl">Consultoria especializada em gestão empresarial.</em>
                </h2>
