...
const TITLE = "Mapeamento de Processos para Empresas | UFABC Jr.";
const DESCRIPTION =
  "Mapeamento e otimização de processos: menos gargalos, retrabalho e custos com fluxos AS-IS/TO-BE e implantação. Diagnóstico gratuito com a Empresa Júnior da UFABC.";
const CANONICAL = "https://ufabcjr.com.br/mapeamento-de-processos";

const differentials = [
  "Fluxos AS-IS e TO-BE documentados e validados com o time",
  "Gargalos e retrabalhos identificados com evidência",
  "Procedimentos padrão prontos para treinar a equipe",
  "Plano de implantação com responsáveis e prazos",
];

const MapeamentoProcessos = () => {
  const ctaRef = useRef<HTMLDivElement>(null);
  const service = services.find((s) => s.id === "processos")!;
    ...
    <div id="top" className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-20 md:pt-24">
        ...
        <section className="py-16 md:py-20 border-t border-border bg-background">
          <div className="container max-w-4xl text-center">
            ...
            <h2 className="font-display text-3xl md:text-4xl font-medium leading-tight text-balance mb-10">
              Processos que rodam sozinhos — não um manual esquecido.
            </h2>
        ...
        <div id="contato" ref={ctaRef}>
          <CTASection
            service={service.tab}
            serviceId="mapeamento-de-processos"
